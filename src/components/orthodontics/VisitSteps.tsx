  ...
  return (
    <section id="visit-steps" className="py-14 md:py-20 px-4 bg-[#E5DEFF]/40 scroll-mt-24">
      <div className="container mx-auto max-w-4xl">
        <TranslatedText
          textKey="orthodontics.visitSteps.title"
          as="h2"
          className="text-2xl font-bold text-[#6E59A5] mb-12 text-center opacity-0 animate-[fade-in_0.5s_ease-out_forwards]"
        />
            ...
            {steps.map((step: any, idx: number) => (
              ...
              >
                ...
                <div className="text-center space-y-1">
                  <div className="font-bold text-[#6E59A5]">{step.title}</div>
                  <div className="text-[#6E59A5]/70 text-sm hidden md:block">{step.description}</div>
                </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mt-10 gap-4 bg-white/80 rounded-xl p-4 shadow-sm border border-dental-beige/30">
          <div className="flex items-center text-[#6E59A5]">
            ...
            <TranslatedText textKey="orthodontics.visitSteps.footer.duration" />
          </div>
          <TranslatedText 
            textKey="orthodontics.visitSteps.footer.note" 
            className="text-[#6E59A5]/70 text-sm md:text-base" 
          />
        </div>
      </div>
    </section>
