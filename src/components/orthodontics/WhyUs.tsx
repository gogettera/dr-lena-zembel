...
const WhyUs = () => {
  ...
  const reasons = t('orthodontics.whyUs.reasons', { returnObjects: true }) || [];
    ...
    <section id="why-us" className="py-16 bg-gradient-to-b from-white to-dental-beige/20">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-dental-navy text-center mb-3">
          <TranslatedText textKey="orthodontics.whyUs.title" />
        </h2>
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          <TranslatedText textKey="orthodontics.whyUs.subtitle" />
        </p>
