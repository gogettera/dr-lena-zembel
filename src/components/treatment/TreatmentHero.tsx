...
const TreatmentHero: React.FC<TreatmentHeroProps> = ({ 
  ...
  return (
    <section className="relative bg-gradient-to-br from-dental-beige via-dental-pink to-white py-12 md:py-20 lg:py-28 overflow-hidden w-full">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23FF6B6B" fill-opacity="0.03"%3E%3Ccircle cx="30" cy="30" r="2"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-50"></div>
