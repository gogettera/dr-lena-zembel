...
import { ChevronLeft, ChevronRight, Phone, Clock, Award, Users, Shield, Calendar } from 'lucide-react';
...
interface ProfessionalTreatmentHeroProps {
  treatmentNameKey: string;
  treatmentDescKey: string;
  treatmentSlug: string;
}

const ProfessionalTreatmentHero: React.FC<ProfessionalTreatmentHeroProps> = ({
  treatmentNameKey,
  treatmentDescKey,
  treatmentSlug
}) => {
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div>
              ...
              <p className="text-lg md:text-xl text-dental-navy/80 leading-relaxed">
                <TranslatedText textKey={treatmentDescKey} defaultText="טיפול מקצועי ואיכותי" />
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="flex items-center gap-2 text-sm md:text-base">
                ...
                <span className="text-dental-navy/80 font-medium">
                  <TranslatedText textKey="treatments.hero.trustIndicators.experience" defaultText="13 שנות ניסיון" />
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm md:text-base">
                <Users className="h-5 w-5 text-dental-orange flex-shrink-0" />
                <span className="text-dental-navy/80 font-medium">
                  <TranslatedText textKey="treatments.hero.trustIndicators.patients" defaultText="5000+ מטופלים" />
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm md:text-base">
                <Shield className="h-5 w-5 text-dental-orange flex-shrink-0" />
                <span className="text-dental-navy/80 font-medium">
                  <TranslatedText textKey="treatments.hero.trustIndicators.technology" defaultText="ציוד מתקדם" />
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm md:text-base">
                <Clock className="h-5 w-5 text-dental-orange flex-shrink-0" />
                <span className="text-dental-navy/80 font-medium">זמינים 24/7</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                ...
                <TranslatedText textKey="treatments.booking.consultation" defaultText="ייעוץ ראשוני חינם" />
              </Button>
            ...
            <p className="text-sm text-dental-navy/60">
              <TranslatedText 
                ...
                defaultText="ייעוץ ראשוני ללא התחייבות • זמינים לחירום 24/7"
              />
            </p>
          </div>
                ...
                <div className="text-center space-y-4">
                  ...
                  <div className="pt-4 border-t border-dental-beige/30">
                    <p className="text-sm text-dental-navy/70 leading-relaxed">
                      "אני מאמינה בגישה אישית ומקצועית לכל מטופל. המטרה שלי היא לספק טיפול ברמה הגבוהה ביותר תוך שמירה על נוחות המטופל."
                    </p>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="mt-8 bg-gradient-to-r from-dental-orange/10 to-dental-pink/10 rounded-xl p-4 border border-dental-orange/20">
          <div className="flex items-center justify-center gap-4 text-center">
            ...
            <p className="text-dental-navy font-medium">
              <TranslatedText textKey="treatments.hero.emergency" defaultText="זמינים לטיפול חירום 24/7" />
...
export default ProfessionalTreatmentHero;
