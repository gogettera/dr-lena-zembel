  ...
  const testimonials = [
    {
      ...
      text: t("testimonials.patientTestimonial1.text", "הגעתי בחשש, אך הרופא הסביר כל שלב בסבלנות. עברתי טיפול שורש ללא כאב, ממליץ בחום.")
    },
    {
      name: t("testimonials.patientTestimonial2.name", "רוני ש."),
      text: t("testimonials.patientTestimonial2.text", "שירות מעולה, קיבלתי תמיכה מהצוות גם אחרי הטיפול. תודה רבה!")
    }
  ];
