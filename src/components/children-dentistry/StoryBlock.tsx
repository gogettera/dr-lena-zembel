...
const StoryBlock: React.FC = () => {
  ...
  return (
    <section className="py-14 md:py-20 px-4 bg-gradient-to-b from-[#FFF1F3] to-white">
      <div className="container mx-auto max-w-3xl">
        <div className="bg-white rounded-3xl p-8 md:p-10 relative overflow-hidden shadow-soft">
          {/* Decorative elements */}
          ...
          <div className="relative z-10 text-center">
            <div className="mb-6 flex justify-center">
              <div className="bg-dental-orange/10 p-3 rounded-full">
                <Smile className="h-8 w-8 text-dental-orange" />
              </div>
            </div>
