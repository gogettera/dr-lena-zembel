  ...
  return (
    <section id="faq" className="py-14 md:py-20 px-4 bg-white scroll-mt-24">
      <div className="container mx-auto max-w-3xl">
        <TranslatedText
          textKey="childrenDentistry.faq.title"
          as="h2"
          className="text-2xl font-bold text-dental-navy mb-8 text-center opacity-0 animate-[fade-in_0.5s_ease-out_forwards]"
        />
              ...
              >
                <AccordionTrigger className="px-6 py-4 hover:no-underline">
                  <div className="flex items-center text-right">
                    ...
                    <span className="font-bold text-dental-navy">{item.question}</span>
                  </div>
                </AccordionTrigger>
