      ...
      <div className="md:w-1/2 bg-dental-navy text-white p-8 md:p-16 flex flex-col justify-center">
        <div className="opacity-0 animate-[fade-in_0.5s_ease-out_forwards]">
          ...
          <div className="space-y-4">
            {[
              { href: "#more", text: "ספרו לי עוד" },
              { href: "#about", text: "עלינו" },
              { href: "#treatments", text: "טיפולים" }
            ].map((link, index) => (
              <a 
                key={link.href}
                href={link.href} 
                className="flex items-center text-lg hover:text-dental-orange transition-colors opacity-0 group"
        ...
        <div className="mt-12 opacity-0 animate-[fade-in_0.5s_ease-out_0.6s_forwards]">
          <svg 
            ...
            className="text-dental-orange transform hover:scale-110 transition-transform"
          >
      ...
      <div className="md:w-1/2 bg-dental-pink">
        <div className="h-full flex items-center justify-center p-8">
          <img 
            ...
            className="max-h-full rounded-xl shadow-lg hover:scale-105 transition-transform duration-300 opacity-0 animate-[fade-in_0.5s_ease-out_0.3s_forwards]"
          />
        </div>
      </div>
    </section>
