...
const BrandSection = () => {
  ...
  return <section id="patients" className="flex flex-col md:flex-row" dir={isRTL ? 'rtl' : 'ltr'}>
      <div className="md:w-1/2 bg-dental-navy text-white p-8 md:p-16 flex flex-col justify-center">
        <div className="opacity-0 animate-[fade-in_0.5s_ease-out_forwards]">
          ...
          <div className="space-y-5 mb-10">
            {[{
            icon: CheckCircle,
            text: t('experiencedDoctors')
          }, {
            icon: Star,
            text: t('advancedEquipment')
          }, {
            icon: Clock,
            text: t('shortWaits')
          }].map((item, index) => <div key={index} className={`flex items-center gap-3 opacity-0 animate-[fade-in_0.5s_ease-out_forwards]`} style={{
          ...
          <Button variant="orange" size="lg" className="rounded-full text-base hover:scale-105 transition-transform duration-300 shadow-lg opacity-0 animate-[fade-in_0.5s_ease-out_0.8s_forwards]">
      ...
      <div className="md:w-1/2 bg-gradient-to-br from-dental-pink to-dental-beige relative overflow-hidden">
        ...
        <div className="h-full flex items-center justify-center p-8">
          <div className="relative">
            ...
            <img alt="רופאת שיניים במרפאה" className="relative max-h-full rounded-xl shadow-xl hover:scale-105 transition-transform duration-300 opacity-0 animate-[fade-in_0.5s_ease-out_0.3s_forwards] object-cover" src="/lovable-uploads/5f625d79-c4c0-4279-8df1-06890084db8c.png" />
          </div>
        </div>
      </div>
    </section>;
